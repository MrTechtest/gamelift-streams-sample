...
export interface GameLiftStreamsArgs {
	...
	/**
	 * HTML audio element which will be used to play the stream audio. Only
	 * provide this if you need direct control of audio specifically. When an
	 * audio element is not provided, the audio and video tracks are played out
	 * through the same MediaStream object.
	 */
...
export interface GameLiftStreamsStreamConfiguration {
	...
	/**
	 * [EXPERIMENTAL] Force the use of the TURN relay that has been specified in iceServers. This
	 * setting is experimental and may be removed in the future. It is not recommended outside of specific
	 * enterprise scenarios where clients are known to be behind a restrictive firewall. (default: false)
	 */
	forceRelay?: boolean;
	/**
